      ...
      <div>
        <div class="text-center">
          <Icon
            ...
            class="w-20 h-20 text-gray-700 dark:text-gray-600"
          />
          <h1 class="mt-5 text-2xl font-semibold">No Product Found</h1>
        </div>
      </div>
    </div>
    <div v-else>
      <span>
        <h1 class="mb-5 text-2xl font-semibold">Recommended Product</h1>
      </span>
